...
int main(int argc, char *argv[]){
	...
	TCPRequestChannel main_channel("", port);
    struct sockaddr_storage client_addr; // Client's addr info
    socklen_t sin_size;
	while(true) { // wait for and handle one connection at a time
	    ...
	    auto *client_channel = new TCPRequestChannel(client_socket);
